import gym
import numpy as np
from Utils.atari_wrapper import make_wrap_atari
...
"""
Below average lynbrook standards
Avg sat score
LMK if any ideas
Trying hard to start another business
cant coursage --> covid
frustrated --> not original
snack business --> dont start a business just to start a business
just chill --> explore --> see where life takes me

Live a meaningful life > rich life with no fun
